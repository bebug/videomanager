...
function uploadSuccess(file, serverData) {
	try {
		...
		progress.toggleCancel(false);
		location.href = "/index.php/videoupload/completeupload"+get;
		//window.location = "/index.php/videoupload/completeupload"+get;
...
function uploadError(file, errorCode, message) {
	try {
		...
		case SWFUpload.UPLOAD_ERROR.SECURITY_ERROR:
			progress.setStatus("Security Error" + " Error Code: Security Error, File name: " + file.name + ", Message: " + message);
