<?php
	...
	$mcFileManagerConfig['general.language'] = "de"; // en, sv
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,ico,css";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,txt,zip,ico,css";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,png,pdf,txt,zip,ico,css";
	...
	$mcFileManagerConfig['authenticator.login_page'] = "login.html";
	$mcFileManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "mc_LoggedIn";
