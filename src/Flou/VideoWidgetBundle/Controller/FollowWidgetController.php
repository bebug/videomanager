...
use Flou\VideoWidgetBundle\Entity\FollowWidget;

use Flou\VideoWidgetBundle\Form\Type\FollowWidgetType;
...
class FollowWidgetController extends Controller
{
	public function newAction(Request $request)
	{
		$widget = new FollowWidget();
		$widget->setTitle(new Title());
		$em = $this->getDoctrine()->getEntityManager();
		$user = $this->get('security.context')->getToken()->getUser();
		
		$form = $this->createForm(new FollowWidgetType($user->getChannel()->getId()), $widget);
		...
		return $this->render('FlouVideoWidgetBundle:FollowWidget:edit.html.twig', array(
	...
	public function editAction(Request $request, $id)
	{
		...
		$em = $this->getDoctrine()->getEntityManager();
		$user = $this->get('security.context')->getToken()->getUser();
		$widget = $em->getRepository('FlouVideoWidgetBundle:FollowWidget')->findOneById($id);
