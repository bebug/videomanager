...
use Flou\VideoWidgetBundle\Entity\FbCommentWidget;
...
use Flou\VideoWidgetBundle\Form\Type\FbCommentWidgetType;

class FbCommentWidgetController extends Controller
{
	public function newAction(Request $request)
	{
		$widget = new FbCommentWidget();
		$widget->setTitle(new Title());
		$em = $this->getDoctrine()->getEntityManager();
		$user = $this->get('security.context')->getToken()->getUser();
		
		$form = $this->createForm(new FbCommentWidgetType($user->getChannel()->getId()), $widget);
		...
		return $this->render('FlouVideoWidgetBundle:FbCommentWidget:edit.html.twig', array(
	...
	public function editAction(Request $request, $id)
	{
		...
		$em = $this->getDoctrine()->getEntityManager();
		$user = $this->get('security.context')->getToken()->getUser();
		$widget = $em->getRepository('FlouVideoWidgetBundle:FbCommentWidget')->findOneById($id);
