<?php
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,ico";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,ico";
	...
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "mc_isLoggedIn";
